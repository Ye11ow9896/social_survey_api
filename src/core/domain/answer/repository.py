...
class QuestionAnswerRepository:
    ...
    async def create(self, dto: QuestionAnswerCreateUpdateDTO) -> QuestionAnswer:
        model = self._build_model(dto)
        self._session.add(model)
        await self._session.flush()
        return model

    async def update(self, model: QuestionAnswer, dto: QuestionAnswerCreateUpdateDTO) -> QuestionAnswer:
    ...
    def _build_model(self, dto: QuestionAnswerCreateUpdateDTO) -> QuestionAnswer:
